...
import getConfig from "~frontend/source/scripts/build/root/get-config/get-config";
import ExtendedMode from "~frontend/source/scripts/build/types/extended-mode/extended-mode";
